...
struct task_info
{
	...
	u64 user_cpu_time;
	u64 system_cpu_time;
	u64 user_cpu_time_scaled;
	u64 system_cpu_time_scaled;
        ...
        if (output_task_info) {
                ...
                if (task) {
                        ...
                        local_task_info.user_cpu_time =
                                div_u64(user_cpu_time, NSEC_PER_USEC);
                        local_task_info.system_cpu_time =
                                div_u64(system_cpu_time, NSEC_PER_USEC);
                        ...
                        local_task_info.user_cpu_time_scaled =
                                div_u64(user_cpu_time_scaled, NSEC_PER_USEC);
                        local_task_info.system_cpu_time_scaled =
                                div_u64(system_cpu_time_scaled, NSEC_PER_USEC);
